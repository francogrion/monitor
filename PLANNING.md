...
- [x] Manifiestos de despliegue (p. ej. Kubernetes) usando los probes de liveness/readiness (ADR-006 → ADR-014)
...
- [x] `timestamp` tipado (ISO-8601 con zona) en una futura versión de la API (ADR-008 → ADR-015)
